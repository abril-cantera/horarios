    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <p className="text-muted-foreground text-xs font-mono uppercase tracking-wider">Etiquetas</p>
        </div>
        <button
      ...
      {labels.length === 0 && !showForm ? (
        <div className="bg-card border border-border rounded-xl px-6 py-8 text-center space-y-2">
          ...
          <p className="text-foreground text-sm font-medium">Sin etiquetas</p>
